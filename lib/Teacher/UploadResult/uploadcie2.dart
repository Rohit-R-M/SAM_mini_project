...
class Cie2Screen extends StatefulWidget {
  final String title;
  final String studentID;  // Add studentID as a parameter

  const Cie2Screen({super.key, required this.title, required this.studentID});

  @override
  State<Cie2Screen> createState() => _CieScreenState();
}

class _CieScreenState extends State<Cie2Screen> {
